...
> [!WARNING]
> This recipe modifies warehouse compute state and requires writable mode (`SNOWFLAKE_MCP_READONLY=0`). Ensure explicit approval before executing against production warehouses.
